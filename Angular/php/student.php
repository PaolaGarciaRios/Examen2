...
class Student{
    ...
    public function create_student_info($post_data=array()){
       ...
       $sql="INSERT INTO students (student_name, email_address, contact,country,gender) 
       VALUES ('$student_name', '$email_address', '$contact','$country','$gender');";
    ...
    public function update_student_info($post_data=array()){
       ...
       $sql="UPDATE students SET 
        ...
        $result=  $this->conn->query($sql);                 
         ...
         return 'Error al actualiza registro.';     
        }          
       }   
    }
